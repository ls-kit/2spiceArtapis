                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="row">
                                        ...
                                        <div class="col-6 form_gallery form-group">
                                            <label id="gallery3" for="form_gallery-upload2">Upload Multiple Images</label>
                                            <input data-name="#gallery3" id="form_gallery-upload2" name="images[]" class="form_gallery-upload" type="file" accept=".png,.jpg,.jpeg,.gif,.svg" multiple>
