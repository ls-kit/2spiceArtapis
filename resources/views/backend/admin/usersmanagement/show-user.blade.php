    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-1">
        ...
        <div class="card">
          ...
          <div class="card-header text-white @if ($user->activated == 1) bg-danger @else bg-danger @endif">
          ...
          <div class="card-body">
            ...
            <div class="row py-4">
              <div class="col-12">
                <div class="d-flex justify-content-center">
                  <div>
                    <img src="@if ($user->profile && $user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" alt="{{ $user->name }}" class="img-fluid rounded-circle center-block ls_user-image">
                  </div>
                ...
                @if ($user->profile)
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    {!! Form::open(array('url' => 'users/' . $user->id, 'class' => 'd-inline-block', 'data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => trans('usersmanagement.deleteUser'))) !!}
            ...
            @if ($user->name)
              ...
              <div class="row p-4">
                <div class="col-sm-3 col-6 text-larger">
                  <strong>
